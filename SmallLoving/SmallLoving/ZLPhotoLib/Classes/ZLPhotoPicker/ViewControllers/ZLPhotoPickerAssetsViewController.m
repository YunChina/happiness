...
- (UIButton *)doneBtn{
    if (!_doneBtn) {
        ...
        rightBtn.frame = CGRectMake(0, 0, 50, 44-20);
        [rightBtn setTitle:@"上传" forState:UIControlStateNormal];
        [rightBtn setBackgroundImage:[UIImage imageNamed:@"album-delete-btn"] forState:UIControlStateNormal];
...
- (void) setupButtons{
    ...
    [backButton setSelfWithImageName:@"nav-bar-white-back-btn" title:@"相册    "];
...
- (void) setupToorBar{
    ...
    [toorBar setBackgroundImage:[UIImage imageNamed:@"album-editing-bar-bg"] forToolbarPosition:nil barMetrics:nil];
